...
// exception of usage within unittests.
        ...
        ndmsg.ndm_family = byteBuffer.get();
        ndmsg.ndm_ifindex = byteBuffer.getInt();
        ndmsg.ndm_state = byteBuffer.getShort();
        ndmsg.ndm_flags = byteBuffer.get();
        ndmsg.ndm_type = byteBuffer.get();
